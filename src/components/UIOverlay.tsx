...
interface UIOverlayProps {
  ...
  onDismantle: () => void;
  onRebuild: (type: 'TexasAM' | 'Eagle' | 'Cat') => void;
...
export const UIOverlay: React.FC<UIOverlayProps> = ({
  ...
  // Only show default presets if the current model is the original Eagle or TexasAM
  const isPreset = currentBaseModel === 'Eagle' || currentBaseModel === 'TexasAM';
