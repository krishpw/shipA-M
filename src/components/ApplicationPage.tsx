      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-4">
          <div className="font-sans font-bold text-xl tracking-tighter text-white">
            SH1P <span className="text-[#500000]">A&M</span>
          </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <button 
            onClick={onApply} 
            className="px-5 py-2 bg-white text-black font-mono text-xs font-bold uppercase hover:bg-[#500000] hover:text-white transition-colors border border-white hover:border-[#500000]"
          >
            Apply Now
          </button>
        </div>
...
const Hero: React.FC<{ onApply: () => void }> = ({ onApply }) => (
    <section className="relative min-h-screen w-full flex flex-col items-center justify-center pt-20 px-6">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#500000]/10 rounded-full blur-[128px] mix-blend-screen animate-pulse"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-8 flex flex-col gap-6">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-3">
            <div className="h-[1px] w-12 bg-[#500000]"></div>
            <span className="font-mono text-[#500000] text-xs tracking-widest uppercase">The Venture Engine</span>
          </motion.div>
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-6xl md:text-8xl lg:text-9xl font-sans font-bold leading-none tracking-tighter text-white">
            SH1P <span className="text-transparent bg-clip-text bg-gradient-to-b from-[#500000] to-[#300000]">A&M</span>
          </motion.h1>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            ...
            <p className="max-w-xl text-slate-400 text-lg leading-relaxed">
              The Premiere Venture Capital Division at Texas A&M. SH1P A&M is the deployed operational spoke of the SH1P National Arm and Catalyst Ventures. We bridge the gap between academic theory and institutional deployment.
            </p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="flex flex-wrap items-center gap-4 mt-4">
            <button onClick={onApply} className="group relative overflow-hidden bg-white text-black px-8 py-4 font-mono font-bold uppercase tracking-wide flex items-center gap-3 hover:bg-[#500000] hover:text-white transition-all">
        ...
        <div className="lg:col-span-4 relative hidden lg:block h-[400px]">
          <div className="absolute inset-0 border border-slate-800 bg-slate-900/50 backdrop-blur-sm p-6 flex flex-col justify-between font-mono text-xs">
             <div className="flex justify-between text-slate-500 border-b border-slate-800 pb-4">
                <span>SYSTEM_ID: SH1P_AM_01</span>
                <span className="text-emerald-500">CONNECTED</span>
             </div>
             <div className="space-y-4 my-auto">
                <div className="space-y-1">
                   <div className="text-slate-500">CAPITAL_DEPLOYMENT</div>
                   <div className="h-1 w-full bg-slate-800 overflow-hidden"><motion.div initial={{ width: 0 }} animate={{ width: "78%" }} transition={{ duration: 2, delay: 1 }} className="h-full bg-[#500000]"></motion.div></div>
                </div>
                <div className="space-y-1">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <div className="flex items-center gap-2 mb-6">
                <span className="w-2 h-2 bg-[#500000]"></span>
            ...
            <p className="text-lg text-slate-300 leading-relaxed mb-6">
              We operate with a single thesis: high-agency individuals need a vehicle to compound their output. SH1P A&M aggregates the highest-agency builders and operators at Texas A&M University.
            </p>
        </motion.div>
        <div className="grid grid-cols-1 gap-6">
             <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="bg-slate-900/50 border border-slate-800 p-8">
                <div className="flex items-start justify-between mb-4">
                    ...
                    <TrendingUp className="text-[#500000] w-6 h-6" />
                </div>
...
const Program: React.FC = () => (
    <section className="py-24 px-6 relative overflow-hidden bg-[#050A14]">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-16">
            <span className="font-mono text-sm text-[#500000] uppercase tracking-widest block mb-4">Operational Verticals</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="group bg-[#02040A] border border-slate-800 hover:border-[#500000] transition-all p-8 md:p-12 flex flex-col h-full">
                <div className="mb-8 flex items-center justify-between">
                    <div className="p-3 bg-[#500000]/10 border border-[#500000]/20 text-[#500000] rounded"><Briefcase className="w-6 h-6" /></div>
                    <span className="font-mono text-4xl font-bold text-slate-800 group-hover:text-[#500000]/20 transition-colors">01</span>
                </div>
        ...
        <section className="py-24 px-6 border-b border-slate-800 bg-[#02040A]">
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                ...
                <div className="px-4 py-2 bg-slate-900 border border-[#500000]/30 text-[#500000] text-xs font-mono">Speed is a feature. Adhere to the timeline.</div>
            </div>
            <div className="border border-slate-800 bg-slate-900/50 divide-y divide-slate-800">
                {events.map((evt, i) => (
                    <div key={i} className={`grid grid-cols-1 md:grid-cols-12 p-6 items-center gap-4 hover:bg-white/5 transition-colors ${evt.highlight ? 'bg-white/5' : ''}`}>
                        <div className="md:col-span-5"><div className={`font-bold text-lg ${evt.critical ? 'text-[#500000]' : 'text-white'}`}>{evt.name}</div></div>
    ...
    return (
        <section className="py-24 px-6 bg-[#02040A]">
          <div className="max-w-7xl mx-auto">
            <div className="mb-16 max-w-2xl"><h2 className="text-3xl font-sans font-bold text-white mb-2">The Operators</h2><div className="h-1 w-20 bg-[#500000] mb-4"></div><p className="text-slate-500">Led by founders and active market participants. No theorists.</p></div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {leaders.map((leader, i) => (
                    <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }} className="group border border-slate-800 bg-slate-900 hover:bg-[#02040A] p-8">
                        <div className="font-mono text-xs text-[#500000] uppercase tracking-widest mb-6">{leader.role}</div>
       ...
       <footer className="bg-[#02040A] py-12 px-6 border-t border-slate-800">
         <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
           <div className="flex items-center gap-2">
               <span className="font-sans font-bold text-white tracking-tight">SH1P <span className="text-[#500000]">A&M</span></span>
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.95, opacity: 0, y: 20 }} className="relative w-full max-w-2xl bg-[#050505] border border-slate-800 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
              ...
              {isSuccess ? (
                ...
                <div className="flex-1 flex flex-col">
                  <div className="h-1 w-full bg-slate-800"><motion.div className="h-full bg-[#500000]" initial={{ width: "33%" }} animate={{ width: `${(step / totalSteps) * 100}%` }} /></div>
                      ...
                      {step === 1 && (
                        <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                          ...
                          <div className="space-y-4">
                            <div><label className="block text-xs font-mono text-slate-500 mb-2 uppercase">Full Legal Name</label><input type="text" value={formData.fullName} onChange={(e) => handleInputChange('fullName', e.target.value)} className="w-full bg-[#0A0F18] border border-slate-800 p-3 text-white focus:border-[#500000] outline-none font-sans" placeholder="Enter name..." autoFocus /></div>
                            <div>
                              <label className="block text-xs font-mono text-slate-500 mb-2 uppercase">Email Address</label>
                              <div className="relative">
                                {/* Simplified Email Input */}
                                <input type="email" value={formData.email} onChange={(e) => handleInputChange('email', e.target.value)} className={`w-full bg-[#0A0F18] border p-3 text-white outline-none font-sans ${formData.email.length > 0 && !formData.email.includes('@') ? 'border-red-500/50 focus:border-red-500' : 'border-slate-800 focus:border-[#500000]'}`} placeholder="user@example.com" />
                              </div>
                            </div>
                            <div><label className="block text-xs font-mono text-slate-500 mb-2 uppercase">LinkedIn URL</label><input type="text" value={formData.linkedin} onChange={(e) => handleInputChange('linkedin', e.target.value)} className="w-full bg-[#0A0F18] border border-slate-800 p-3 text-white focus:border-[#500000] outline-none font-sans" placeholder="linkedin.com/in/..." /></div>
                          </div>
                        </motion.div>
                      )}
                      {step === 2 && (
                          ...
                          <div className="space-y-6">
                            <div>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <button type="button" onClick={() => handleInputChange('track', 'analyst')} className={`p-4 border text-left transition-all relative ${formData.track === 'analyst' ? 'bg-[#500000]/10 border-[#500000]' : 'bg-[#0A0F18] border-slate-800 hover:border-slate-600'}`}>
                                  {formData.track === 'analyst' && <div className="absolute top-2 right-2 text-[#500000]"><Disc className="w-4 h-4 animate-spin" /></div>}<div className={`font-bold mb-1 ${formData.track === 'analyst' ? 'text-[#500000]' : 'text-white'}`}>Analyst Program</div><div className="text-xs text-slate-500">Buy-Side. Capital Allocation.</div>
                                </button>
                            ...
                            <div><label className="block text-xs font-mono text-slate-500 mb-2 uppercase">Campus Involvement</label><textarea value={formData.clubs} onChange={(e) => handleInputChange('clubs', e.target.value)} className="w-full bg-[#0A0F18] border border-slate-800 p-3 text-white focus:border-[#500000] outline-none font-sans resize-none h-24" placeholder="List relevant clubs..." /></div>
                          </div>
                        </motion.div>
                      )}
                      {step === 3 && (
                        <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6">
                          ...
                          <div className="space-y-4">
                            <div><label className="block text-xs font-mono text-slate-500 mb-2 uppercase">{formData.track === 'analyst' ? "Why are you a fit for the buy-side? (Your Investment Thesis)" : "What are you building? (Product Description & Status)"}</label><textarea value={formData.essay} onChange={(e) => handleInputChange('essay', e.target.value)} className="w-full bg-[#0A0F18] border border-slate-800 p-3 text-white focus:border-[#500000] outline-none font-sans resize-none h-48" placeholder={formData.track === 'analyst' ? "Convince us..." : "Describe your MVP..."} autoFocus /></div>
                          </div>
                        </motion.div>
                      )}
                    </AnimatePresence>
